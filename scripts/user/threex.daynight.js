...
THREEx.DayNight.SunSphere	= function(){
	var geometry	= new THREE.SphereGeometry( 90, 30, 30 )
	var material	= new THREE.MeshBasicMaterial({
		color		: 0xff0000
	})
	var mesh	= new THREE.Mesh(geometry, material)
	...
	this.update	= function(sunAngle){
		mesh.position.x = 0;
		mesh.position.y = Math.sin(sunAngle) * 1400;
		mesh.position.z = Math.cos(sunAngle) * 1400;
...
THREEx.DayNight.Skydom		= function(){
	var geometry	= new THREE.SphereGeometry( 1750, 32, 15 );
